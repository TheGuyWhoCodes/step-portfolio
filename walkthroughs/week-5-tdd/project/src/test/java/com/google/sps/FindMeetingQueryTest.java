...
//     // Options : |--1--|         |--2--|
  ...
  public void everyAttendeeIsConsideredOptionalAllDay() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartDuration(0, TimeRange.END_OF_DAY),
            Arrays.asList(PERSON_C)));
  ...
  @Test
  public void noMandatoryNoGap() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(0, TimeRange.END_OF_DAY, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartEnd(0, TimeRange.END_OF_DAY, false),
            Arrays.asList(PERSON_B)));
  ...
  @Test
  public void noMandatorySomeGap() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(0, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),
 ...
 @Test
  public void justEnoughRoomOptional() {
    // Have one person, ` make it so that there is just enough room at one point in the day to
    // have the meeting.
    //
    // Events  : |--A--|     |----A----|
    // Day     : |---------------------|
